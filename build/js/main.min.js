...
/*!****************************************************************!*\
  !*** ../node_modules/rough-notation/lib/rough-notation.esm.js ***!
  \****************************************************************/
/*! exports provided: annotate, annotationGroup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "annotate", function() { return _; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "annotationGroup", function() { return m; });
...
/* harmony import */ var _modules_init_change_language__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-change-language */ "./js/modules/init-change-language.js");
/* harmony import */ var _modules_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/init-dynamic-adaptive */ "./js/modules/init-dynamic-adaptive.js");
/* harmony import */ var _modules_init_change_color_theme__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/init-change-color-theme */ "./js/modules/init-change-color-theme.js");
/* harmony import */ var _modules_init_tabs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/init-tabs */ "./js/modules/init-tabs.js");
/* harmony import */ var _modules_annotate_text_blocks__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/annotate-text-blocks */ "./js/modules/annotate-text-blocks.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  Object(_modules_init_change_color_theme__WEBPACK_IMPORTED_MODULE_7__["initChangeColorTheme"])();
  Object(_modules_init_change_language__WEBPACK_IMPORTED_MODULE_5__["initChangeLanguage"])();
  // ---------------------------------
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_6__["initDynamicAdaptive"])();
    Object(_modules_init_burger_menu__WEBPACK_IMPORTED_MODULE_4__["initBurgerMenu"])();
    Object(_modules_init_tabs__WEBPACK_IMPORTED_MODULE_8__["initTabs"])();
    Object(_modules_annotate_text_blocks__WEBPACK_IMPORTED_MODULE_9__["annotateTextBlocks"])();
  });
});
...
/***/ "./js/modules/annotate-text-blocks.js":
/*!********************************************!*\
  !*** ./js/modules/annotate-text-blocks.js ***!
  \********************************************/
/*! exports provided: annotateTextBlocks */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "annotateTextBlocks", function() { return annotateTextBlocks; });
...
var annotateTextBlocks = function annotateTextBlocks() {
  var titles = Array.from(document.querySelectorAll('[data-lang-key="headersSection"]'));
  var titlesAnotation = titles.map(function (item) {
    return Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(item, {
      type: 'highlight',
      color: 'orange'
    });
  });
  Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotationGroup"])(titlesAnotation).show();
  var introText = document.querySelector('.intro__text');
  var annotationIntroText = Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(introText, {
    type: 'highlight',
    color: 'yellowgreen'
  });
  annotationIntroText.show();
  var aboutListItems = Array.from(document.querySelectorAll('.about__list-item p'));
  var aboutListItemsAnotation = aboutListItems.map(function (item) {
    return Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(item, {
      type: 'highlight',
      color: 'coral'
    });
  });
  Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotationGroup"])(aboutListItemsAnotation).show();
  var aboutLinkItems = Array.from(document.querySelectorAll('.about__link'));
  var aboutLinkItemsAnotation = aboutLinkItems.map(function (item) {
    return Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(item, {
      type: 'box',
      color: 'red'
    });
  });
  Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotationGroup"])(aboutLinkItemsAnotation).show();
  var textAccentItems = Array.from(document.querySelectorAll('.about__text--accent'));
  var textAccentItemsAnotation = textAccentItems.map(function (item) {
    return Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(item, {
      type: 'highlight',
      color: 'yellowgreen'
    });
  });
  Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotationGroup"])(textAccentItemsAnotation).show();
  var portfolioLinks = Array.from(document.querySelectorAll('.portfolio__link'));
  var portfolioLinksAnotation = portfolioLinks.map(function (item) {
    return Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(item, {
      type: 'box',
      color: 'red'
    });
  });
  Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotationGroup"])(portfolioLinksAnotation).show();
  var portfolioTabs = Array.from(document.querySelectorAll('.tabs__control-border'));
  var portfolioTabsAnotation = portfolioTabs.map(function (item) {
    return Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotate"])(item, {
      type: 'box',
      color: 'black'
    });
  });
  Object(rough_notation__WEBPACK_IMPORTED_MODULE_0__["annotationGroup"])(portfolioTabsAnotation).show();
};
...
var initBurgerMenu = function initBurgerMenu() {
  ...
  var navigationList = header.querySelector('.navigation-changer__menu'); //__list
  var navigationButton = header.querySelector('.navigation-changer__toggle');
  //
  var returnHeightAuto = function returnHeightAuto() {
  ...
  var openMenu = function openMenu() {
    ...
    navigationList.style.setProperty('height', "".concat(height, "px"));
...
/***/ "./js/modules/init-change-color-theme.js":
/*!***********************************************!*\
  !*** ./js/modules/init-change-color-theme.js ***!
  \***********************************************/
/*! exports provided: initChangeColorTheme */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeColorTheme", function() { return initChangeColorTheme; });
var getSystemScheme = function getSystemScheme() {
  var darkScheme = matchMedia('(prefers-color-scheme: dark)').matches;
  return darkScheme ? 'dark' : 'light';
};
var getSavedColorTheme = function getSavedColorTheme() {
  return localStorage.getItem('color-theme');
};
var setColorTheme = function setColorTheme(colorValue) {
  return localStorage.setItem('color-theme', colorValue);
};
var changeColorTheme = function changeColorTheme(colorValue) {
  document.body.setAttribute('data-color-theme', colorValue);
};
var setColorThemeValue = function setColorThemeValue(evt) {
  var colorTheme = evt.target.value;
  setColorTheme(colorTheme);
  changeColorTheme(colorTheme);
};
var initChangeColorTheme = function initChangeColorTheme() {
  var savedColorThemeValue = getSavedColorTheme();
  var currentRadio;
  if (savedColorThemeValue !== null) {
    document.body.setAttribute('data-color-theme', savedColorThemeValue);
    currentRadio = document.querySelector("[name=\"toggle-color-theme\"][value=".concat(savedColorThemeValue, "]"));
  } else {
    document.body.setAttribute('data-color-theme', getSystemScheme());
    currentRadio = document.querySelector("[name=\"toggle-color-theme\"][value=".concat(getSystemScheme(), "]"));
  }
  currentRadio.checked = true;
  var toggleColorTheme = document.querySelector('[data-toggle-color-theme]');
...
/***/ "./js/modules/init-change-language.js":
/*!********************************************!*\
  !*** ./js/modules/init-change-language.js ***!
  \********************************************/
/*! exports provided: initChangeLanguage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChangeLanguage", function() { return initChangeLanguage; });
/* harmony import */ var rough_notation__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! rough-notation */ "../node_modules/rough-notation/lib/rough-notation.esm.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var pathContent = "data/site-content.json";
var lang = "ru";
var fetchContentData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(path) {
    var response, message, contentData;
  ...
  return function fetchContentData(_x) {
    return _ref.apply(this, arguments);
  };
}();
var getSavedLang = function getSavedLang() {
  return localStorage.getItem('lang-value');
};
var setLang = function setLang(langValue) {
  return localStorage.setItem('lang-value', langValue);
};
var setLanguageValue = function setLanguageValue(evt) {
  lang = evt.target.value;
  setLang(lang);
  changeLanguage(lang);
};
var changeLanguage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(langValue) {
    var languageData, _loop, key;
    return _regeneratorRuntime().wrap(function _callee2$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return fetchContentData(pathContent);
        case 3:
          languageData = _context3.sent;
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop(key) {
            var elems;
            return _regeneratorRuntime().wrap(function _loop$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  elems = Array.from(document.querySelectorAll("[data-lang-key=\"".concat(key, "\"]")));
                  if (elems.length) {
          ...
          _context3.t0 = _regeneratorRuntime().keys(languageData);
        case 6:
          ...
          return _context3.delegateYield(_loop(key), "t2", 9);
        case 9:
          _context3.next = 6;
          break;
        case 11:
        ...
        case 14:
          ...
          console.log(_context3.t3.message);
        case 17:
        case "end":
...
var initChangeLanguage = function initChangeLanguage() {
  var savedLangValue = getSavedLang();
  var currentRadio;
  if (savedLangValue !== null) {
    currentRadio = document.querySelector("[name=\"toggle-language\"][value=".concat(savedLangValue, "]"));
    lang = savedLangValue;
  } else {
  ...
  currentRadio.checked = true;
  changeLanguage(lang);
  var toggleLanguage = document.querySelector('[data-toggle-language]');
...
/*!*********************************************!*\
  !*** ./js/modules/init-dynamic-adaptive.js ***!
  \*********************************************/
/*! exports provided: initDynamicAdaptive */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initDynamicAdaptive", function() { return initDynamicAdaptive; });
/* harmony import */ var _dynamic_adaptive__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dynamic-adaptive */ "./js/modules/dynamic-adaptive.js");

var togglesContainer = document.querySelector('.toggles-container');
